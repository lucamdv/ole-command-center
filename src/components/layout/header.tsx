...
export function Header({ onOpenPalette }: { onOpenPalette: () => void }) {
  ...
  return (
    <header className="h-14 shrink-0 border-b border-border bg-background/70 backdrop-blur-xl flex items-center px-5 gap-4 sticky top-0 z-30">
      ...
      <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-info grid place-items-center text-[11px] font-semibold text-primary-foreground ring-2 ring-background">
        RM
      </div>
    </header>
  );
